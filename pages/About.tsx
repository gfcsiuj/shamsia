  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="py-20 container mx-auto px-4 text-center">
        ...
        <div className="mt-16 bg-slate-100 p-8 rounded-2xl inline-block max-w-4xl animate-scale-in delay-300 border border-slate-200">
          <h3 className="text-lg font-bold text-slate-800 mb-4">الشهادات المعتمدة</h3>
          <div className="flex gap-4 justify-center">
            <div className="w-32 h-40 bg-white border border-slate-200 shadow-sm flex items-center justify-center text-xs text-slate-400 hover:shadow-lg hover:border-primary-300 transition">نموذج شهادة 1</div>
            <div className="w-32 h-40 bg-white border border-slate-200 shadow-sm flex items-center justify-center text-xs text-slate-400 hover:shadow-lg hover:border-primary-300 transition">نموذج شهادة 2</div>
          </div>
        </div>
      </div>
    </div>
