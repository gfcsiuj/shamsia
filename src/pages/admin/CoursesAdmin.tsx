          ...
          <div className="fixed inset-0 z-50 bg-slate-100 flex flex-col animate-fade-in overflow-hidden">
             ...
             <div className="flex-1 overflow-y-auto p-6 md:p-8">
                 <div className="max-w-5xl mx-auto space-y-8">
                         ...
                         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
                             ...
                             <div className="lg:col-span-2 space-y-6">
                                 <div className="ca-card">
                                     <h3 className="ca-section-title">معلومات الدورة</h3>
                                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                         <div className="md:col-span-2">
                                             <label className="ca-label">عنوان الدورة</label>
                                             <input type="text" className="ca-input" value={formData.title} onChange={e => setFormData({...formData, title: e.target.value})} placeholder="مثال: أساسيات البرمجة بلغة بايثون" />
                                         </div>
                                         <div>
                                         ...
                                         <div>
                                             <label className="ca-label">المستوى</label>
                                 ...
                                 <div className="ca-card border-primary-100 bg-primary-50/50">
                                      <h3 className="ca-section-title text-primary-800 border-primary-100">المدربين</h3>
                                      ...
                                      <div className="relative group">
                                          <button type="button" className="ca-input text-start text-slate-500 flex justify-between items-center bg-white">
                                 ...
                                 <div className="ca-card border-blue-100 bg-blue-50/30">
                                     <h3 className="ca-section-title text-blue-800 border-blue-100">الوسائط (الغلاف والفيديو)</h3>
                             ...
                             <div className="space-y-6">
                                 <div className="ca-card border-emerald-100 bg-emerald-50/30">
                                     <h3 className="ca-section-title text-emerald-800 border-emerald-100">التسعير والوقت</h3>
                                     <div className="space-y-4">
                                         <div>
                                             <label className="ca-label">السعر الحالي (د.ع)</label>
                                             <input type="number" className="ca-input" value={formData.price} onChange={e => setFormData({...formData, price: Number(e.target.value)})} />
                                         </div>
                                         <div>
                                             <label className="ca-label">السعر السابق (اختياري)</label>
                                             <input type="number" className="ca-input" value={formData.oldPrice} onChange={e => setFormData({...formData, oldPrice: Number(e.target.value)})} />
                                         </div>
                                         <div>
                                 ...
                                 <div className="ca-card">
                                     ...
                                     <div className="space-y-4">
                                         ...
                                         <div>
                                             <label className="ca-label flex justify-between">
                                             ...
                                             <input 
                                                type="number" 
                                                className={`ca-input ${formData.studentsCountMode === 'auto' ? 'bg-slate-50 text-slate-400' : ''}`} 
                     ...
                     {activeTab === 'details' && (
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in">
                             <div className="md:col-span-2 ca-card">
                                 <h3 className="ca-section-title">الأوصاف</h3>
                                 <div className="space-y-4">
                                     <div>
                                         <label className="ca-label">وصف مختصر (للكارد)</label>
                                         <textarea className="ca-input" rows={3} value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})}></textarea>
                                     </div>
                                     <div>
                                         <label className="ca-label">الإعلان التفصيلي</label>
                                         <textarea className="ca-input font-mono text-sm" rows={12} value={formData.longDescription} onChange={e => setFormData({...formData, longDescription: e.target.value})}></textarea>
                                     </div>
                                 </div>
                             </div>

                             <div className="ca-card h-full border-orange-100 bg-orange-50/30">
                                 <div className="flex justify-between items-center mb-4 border-b border-orange-100 pb-2">
                                     <h3 className="ca-section-title mb-0 border-none text-orange-800">ماذا ستتعلم (Objectives)</h3>
                                 ...
                                 <div className="space-y-2">
                                     {formData.objectives.map((obj, i) => (
                                         <div key={i} className="flex gap-2">
                                             <input type="text" className="ca-input py-2 text-sm" value={obj} onChange={e => handleArrayChange('objectives', i, e.target.value)} />
                             ...
                             <div className="ca-card h-full border-purple-100 bg-purple-50/30">
                                 <div className="flex justify-between items-center mb-4 border-b border-purple-100 pb-2">
                                     <h3 className="ca-section-title mb-0 border-none text-purple-800">الفئة المستهدفة</h3>
                                 ...
                                 <div className="space-y-2">
                                     {formData.targetAudience.map((aud, i) => (
                                         <div key={i} className="flex gap-2">
                                             <input type="text" className="ca-input py-2 text-sm" value={aud} onChange={e => handleArrayChange('targetAudience', i, e.target.value)} />
                             ...
                             <div className="ca-card md:col-span-2">
                                 <div className="flex justify-between items-center mb-4 border-b border-slate-50 pb-2">
                                     <h3 className="ca-section-title mb-0">الشهادات والاعتمادات</h3>
                                 ...
                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                     {formData.certifications?.map((cert, i) => (
                                         <div key={i} className="flex gap-2">
                                             <input type="text" className="ca-input py-2 text-sm" value={cert} onChange={e => handleArrayChange('certifications', i, e.target.value)} placeholder="اسم الشهادة..." />
                     ...
                     {/* Syllabus Tab */}
                     {activeTab === 'syllabus' && (
                         <div className="ca-card animate-fade-in border-indigo-100 bg-indigo-50/10">
                             <div className="flex justify-between items-center mb-6 border-b border-indigo-100 pb-4">
                                <h3 className="ca-section-title mb-0 border-none text-indigo-900">المنهج الدراسي</h3>
                                     ...
                                     <div key={i} className="flex flex-col md:flex-row gap-4 items-start bg-white p-4 rounded-xl border border-indigo-100 shadow-sm relative group">
                                         <div className="w-full md:w-1/4">
                                             <input 
                                                ...
                                                className="ca-input bg-slate-50 border-slate-100 focus:bg-white" 
                                                value={item.week} 
