...
import { TESTIMONIALS } from '../constants'; // Testimonials are still static for now, or could move to context
...
const Home: React.FC = () => {
  const { courses, instructors, siteConfig } = useData();
      ...
      <section className="relative min-h-[500px] lg:h-[600px] flex items-center overflow-hidden py-16 lg:py-0">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="max-w-4xl text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 leading-loose md:leading-relaxed lg:leading-tight animate-fade-in-up tracking-wide whitespace-pre-line">
              <span className="text-secondary-400 block mb-2 sm:mb-4 sm:inline sm:ml-3">شمسية</span>
              {siteConfig.heroTitle}
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-slate-100 mb-10 leading-loose opacity-90 max-w-2xl animate-fade-in-up delay-100 whitespace-pre-line">
